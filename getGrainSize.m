...
elseif sedDatType == 'I' % for using IMLGS data
    ...
    % Run makeIMLGS_HFEVA_WAT.m on downloaded sediment data first
    ...
    % Suggested change: Just have NearSed include all the points in
    % IMLGS_HFEVA_WAT. Even if the closest point to the site is 3X
    % total_range away from the site, it's not necessarily the closest
    % sediment point to ALL points along all the radials. Making this
    % change would get rid of that concern.
...
% [39.832600000000000,-69.980000000000000,960] % hydLoc
% [40.192328642367485,39.831658049018100,39.472871357632500,39.831658049018100] % latout
% [-69.980000000000000,-69.511558323106510,-69.980000000000000,-70.448441676893510] % lonout
%
% deg2km(39.832600000000000 - 40.192328642367485)
% deg2km((-69.980000000000000 - -69.511558323106510), 4892.413)
% deg2km(-69.980000000000000 - -70.448441676893510)
%
%
% km2deg(40)           % = 0.3597
% km2deg(40, 4892.413) % = 0.4684
%
%
% reckon(hydLoc(1), hydLoc(2), distDeg, 15, 'degrees')