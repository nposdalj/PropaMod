...
% WASD 2024-01-10 - Adapt to modern bellhop: ReadShadeHeadBin2.m
...
try
    ...
    %% NEW - Section 1: plot type
    fseek(fid, recl, -1); %reposition to end of first record
    plottype = fread(fid, 10, 'uchar');

    %% OLD - Section 2: Nfreq, Ntheta, Nsx, Nsy, Nsz, Nrz, Nrr, freq0, atten
    ...
    %% NEW - Section 2: Nfreq, Ntheta, Nsx, Nsy, Nsz, Nrz, Nrr, freq0, atten
    fseek(fid, 2*recl, -1); %reposition to end of second record
