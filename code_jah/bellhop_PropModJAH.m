...
settingsPath = 'H:\PropaMod\PropaMod_Settings_compareJAHoutput.xlsx'; % <- Aaron
%settingsPath = 'G:\BellhopOutput'; % <- Natalie
% readSettingsJAH'
readSettings
...
for rad = 1:length(radials)
    ...
    if rad == 1 % If this is currently running the first radial...
        ...
        if SiteDepth < hdepth
            ...
            SD = hdepth; % Set Source Depth (SD) as 10 m above the sea floor.
        end
    end
