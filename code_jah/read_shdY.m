function [ PlotTitle, PlotType, freqVec, atten, Pos, pressure ] = read_shdY( varargin )
% Read the shade file
...
switch FileType
   case { 'shd', 'grn' }   % binary format
      switch nargin
          case 1
         [ PlotTitle, PlotType, freqVec, atten, Pos, pressure ] = read_shd_binY( filename );
          case 2
         [ PlotTitle, PlotType, freqVec, atten, Pos, pressure ] = read_shd_binY( filename, freq );
          case 3
         [ PlotTitle, PlotType, freqVec, atten, Pos, pressure ] = read_shd_binY( filename, xs, ys );
      end
