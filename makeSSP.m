...
Month_End = '2022-12-01';    % Final month of study period. Format as yyyy-MM.
...
%% Save entire SSP data
save(fullfile(SSP_saveDir, Site, strcat(Site, '_SSP_data', '.mat')), 'ALL_SSP', 'SSPT')