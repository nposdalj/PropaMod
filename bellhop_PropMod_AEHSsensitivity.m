...
compressional_speed = 1400:50:1600;   % Compressional speed
shear_speed = 140:5:160;   % Shear speed
density_aehs = 0.9:.1:1.7;        % Density
...
for cS = 1:length(compressional_speed)
    for sS = 1:length(shear_speed)
        for den = 1:length(density_aehs)
            for cA = 1:length(compressional_atten)
