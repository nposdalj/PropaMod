...
userNote = 'OC, Mid-Size'; % Include a note for yourself/others. This will be included in the .txt output.
...
hlat = 40.263; % hydrophone lat
hlon = -67.986; % hydrophone long
hdepth = 563;   % hydrophone depth % <- inputted into DetSim_Workspace
SL = 235;       % Source Level
